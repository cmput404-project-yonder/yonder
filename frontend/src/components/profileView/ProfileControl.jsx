...
// local styling
var boxStyle = Object.assign({}, style.text.body, {
  width: "325pt",
  paddingLeft: "1.3em",
  paddingRight: "1.3em",
  paddingTop: "1.5em",
...
class ProfileControl extends React.Component {
  ...
  switchMode() {
    ...
    if (this.state.isViewMode) this.setState({ isViewMode: false });
  ...
  renderEdit() {
    return (
      <Container style={boxStyle}>
        <ProfileEdit onCancel={this.switchMode} displayName={this.state.authorInfo.authorModel.displayName} />
      </Container>
    );
  }
